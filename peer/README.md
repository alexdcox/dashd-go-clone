...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/alexdcox/dashd-go/peer)
...
```bash
$ go get -u github.com/alexdcox/dashd-go/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/alexdcox/dashd-go/peer#example-package--NewOutboundPeer)  

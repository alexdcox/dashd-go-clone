...
* Download the Conformal public key:
  https://raw.githubusercontent.com/alexdcox/dashd-go/master/release/GIT-GPG-KEY-conformal.txt
...
* Install the MSI available at: [btcd windows installer](https://github.com/alexdcox/dashd-go/releases)
...
```bash
git clone https://github.com/alexdcox/dashd-go $GOPATH/src/github.com/alexdcox/dashd-go
...
* [Using bootstrap.dat](https://github.com/alexdcox/dashd-go/blob/master/docs/configuration.md#using-bootstrapdat)
